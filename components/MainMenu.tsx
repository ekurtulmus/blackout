...
.mm-scrim{position:fixed;inset:0;z-index:1;pointer-events:none;background:radial-gradient(closest-side 50vw 48vh at 50% 46%, rgba(4,3,3,.9), rgba(4,3,3,.64) 55%, rgba(4,3,3,.12) 100%);}
...
.mm-sub{margin-top:22px;font-family:'Cinzel',serif;font-size:13px;letter-spacing:.55em;color:#b3aa93;text-transform:uppercase;opacity:0;animation:mm-fade .9s ease-out .9s forwards;text-shadow:0 1px 6px #000;}
.mm-menu{margin-top:54px;display:flex;flex-direction:column;align-items:center;gap:20px;}
.mm-item{font-family:'Cinzel',serif;font-weight:600;font-size:clamp(18px,2.5vw,22px);letter-spacing:.2em;color:#efe7d6;cursor:pointer;position:relative;padding:14px 46px;min-width:min(320px,84vw);text-align:center;border-radius:8px;background:rgba(14,10,9,.62);border:1px solid rgba(206,186,156,.34);transition:color .25s,background .25s,border-color .25s,text-shadow .25s;opacity:0;transform:translateY(8px);text-shadow:0 2px 6px #000,0 0 18px rgba(0,0,0,.9);}
...
.mm-schip{display:inline-flex;align-items:center;gap:8px;background:rgba(14,10,9,.6);border:1px solid rgba(206,186,156,.34);border-radius:6px;font-family:'Cinzel',serif;font-size:13px;font-weight:600;letter-spacing:.14em;color:#e0d6c0;cursor:pointer;text-transform:uppercase;transition:color .25s,background .25s,border-color .25s;text-shadow:0 1px 5px #000;padding:10px 16px;}
...
.mm-note{color:#c2b79e;letter-spacing:.05em;}
.mm-lore{position:relative;z-index:5;margin-top:30px;pointer-events:none;width:min(620px,86vw);text-align:center;font-style:italic;font-size:15.5px;line-height:1.75;color:#a89f8a;letter-spacing:.03em;text-shadow:0 1px 8px #000,0 0 24px rgba(0,0,0,.9);opacity:0;animation:mm-loreIn 1.6s ease-out 2s forwards, mm-lorePulse 6s 3.6s ease-in-out infinite;}
...
.mm-foot button{background:rgba(14,10,9,.6);border:1px solid rgba(206,186,156,.34);border-radius:6px;padding:11px 22px;font-family:'Cinzel',serif;font-size:12.5px;font-weight:600;letter-spacing:.22em;color:#e0d6c0;cursor:pointer;text-transform:uppercase;transition:color .25s,background .25s,border-color .25s;text-shadow:0 1px 5px #000;}
